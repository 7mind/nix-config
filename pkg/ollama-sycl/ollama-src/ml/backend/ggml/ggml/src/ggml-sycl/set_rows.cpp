...
convert (const char* src, char* dst) {
    ...
    if constexpr (std::is_same_v<TOut, sycl::ext::oneapi::bfloat16>) {
        // Bypass IMF __imf_float2bfloat16_rn (not auto-linked by intel-llvm@unstable-2025-11-14).
        // Use the standard sycl::ext::oneapi::bfloat16(float) constructor instead.
